...
const pl: Record<string, string> = {
  ...
  settings_lang: "Język",
  setting_units: "Rozmiary",
  units_human: "KiB / MiB",
  units_bytes: "bajty",
  units_hex: "hex",
  help_units: "Jak zapisywany jest każdy rozmiar na stronie. Zaokrąglenie czyta się lepiej, ale potrafi sprawić, że dwie różne liczby wyglądają identycznie, bo partycja i obraz w niej często zaokrąglają się tak samo, choć różnią się o kilobajty. Zapis szesnastkowy odpowiada temu, jak już pokazywane są adresy pamięci flash.",
  btn_close: "Zamknij",
  ...
  fleet_missing: "{name} nie został skompilowany w tym wydaniu.",
  view_table: "tabela",
  view_map: "mapa",
  view_numbers: "liczby",
  th_build: "kompilacja",
  ...
  th_fill: "zapełnienie",
  th_check: "kontrola",
  help_col_size: "Ile pamięci flash tablica partycji przeznaczyła na tę partycję.",
  help_col_content: "Jak duży jest obraz do niej zapisany. To nie rozmiar partycji, choć oba często zaokrąglają się tak samo: włącz dokładne bajty w ustawieniach, aby zobaczyć różnicę.",
  help_col_used: "Ile z tego obrazu jest faktycznie zajęte. System plików zwykle buduje się tak, by wypełnił partycję, więc obraz bywa znacznie większy niż jego zawartość.",
  help_col_free: "Rozmiar partycji minus to, co zajęte. Tyle zapasu zostało kompilacji.",
  verified: "zgodne",
  mismatch: "niezgodne",
  ...
  pkg_table_title: "Pakiety",
  pkg_table_sub: "{n} z {total}",
  pkg_map_title: "Udział w rootfs",
  th_package: "pakiet",
  th_bytes: "bajty",
  ...
  stat_config_changed: "zmiany konfiguracji jądra",
