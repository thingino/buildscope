...
const ja: Record<string, string> = {
  ...
  units_bytes: "バイト",
  units_hex: "16 進",
  help_units: "ページ上のサイズをどう表記するか。丸めは読みやすい一方で、異なる二つの数値を同じに見せることがあります。パーティションとその中のイメージは数キロバイト違っても同じ値に丸まるためです。16 進はフラッシュアドレスの表記に揃います。",
  btn_close: "閉じる",
  title_settings: "設定",
  title_home: "最初に戻る",
  title_close: "閉じる",
  ...
  fleet_missing: "{name} はこのリリースではビルドされていません。",
  view_table: "表",
  view_map: "マップ",
  view_numbers: "数値",
  th_build: "ビルド",
  ...
  help_dtb_image: "出荷されるバイナリの中で見つかったツリー。ブートローダの場合はローダ自身のもので、DRAM の起動とフラッシュの読み出しに必要な範囲しか記述しません。",
  help_dtb_payload: "ローダが展開する圧縮ペイロードの中で見つかったツリー。こちらが実際のボードのツリーで、そのカメラに設定された GPIO や周辺機器が入っています。",
  device_trees_note:
