...
const ar: Record<string, string> = {
  ...
  settings_lang: "اللغة",
  setting_units: "الأحجام",
  units_human: "KiB / MiB",
  units_bytes: "بايت",
  units_hex: "ست عشري",
  help_units: "كيف يُكتب كل حجم في الصفحة. التقريب أسهل قراءةً لكنه قد يجعل رقمين مختلفين متطابقين في الشكل، إذ يُقرَّب القسم والصورة التي بداخله إلى القيمة نفسها رغم اختلافهما بكيلوبايتات. أما الست عشري فيطابق طريقة عرض عناوين الفلاش.",
  btn_close: "إغلاق",
  ...
  fleet_missing: "لم يتم بناء {name} في هذا الإصدار.",
  view_table: "جدول",
  view_map: "خريطة",
  ...
  th_fill: "الامتلاء",
  th_check: "التحقق",
  help_col_size: "المساحة التي خصّصها جدول الأقسام لهذا القسم.",
  help_col_content: "حجم الصورة المكتوبة فيه. ليس حجم القسم، وإن كانا يُقرَّبان غالبًا إلى القيمة نفسها: فعّل البايتات الدقيقة في الإعدادات لرؤية الفرق.",
  help_col_used: "المقدار المشغول فعليًا من تلك الصورة. عادةً ما يُبنى نظام الملفات ليملأ قسمه، فقد تكون الصورة أكبر بكثير مما بداخلها.",
  help_col_free: "حجم القسم ناقص المستخدم. هذه هي المساحة المتبقية للبناء.",
  verified: "مطابق",
  mismatch: "غير مطابق",
  ...
  dtb_in_image: "المُحمِّل",
  dtb_in_payload: "u-boot",
  help_dtb_image: "عُثر عليها في الملف كما يُشحن. في مُحمِّل الإقلاع هذه شجرة المُحمِّل نفسه، تصف فقط ما يحتاجه لتشغيل الذاكرة وقراءة الفلاش.",
  help_dtb_payload: "عُثر عليها داخل الحمولة المضغوطة التي يفكّها المُحمِّل. هذه شجرة اللوحة الحقيقية، بمنافذ GPIO والأجهزة التي أُعدّت بها كاميرا بعينها.",
  device_trees_note:
  ...
  stat_device_config: "إعدادات الجهاز",
  device_config_title: "إعدادات الجهاز",
  help_device_config: "ملف إعدادات مسجَّل من نظام الملفات الجذري، تمامًا كما سيقرؤه الجهاز. لا يحمل نظام البناء هذه المعلومات: أي منفذ GPIO يشغّل مرشّح الأشعة تحت الحمراء، أو كم خطوة يحتاجها محرك الدوران، يُقرَّر هنا فقط.",
  ...
  stat_device_config_changed: "تغيّرات إعدادات الجهاز",
  drift_device_config: "إعدادات الجهاز",
  help_build_config_changed: "خيارات Buildroot المضبوطة بشكل مختلف بين البناءين. هنا يبدأ عادةً ظهور حزمة أو تغيّر في الحجم.",
  help_device_config_changed: "القيم المختلفة في ملفات الإعدادات المسجَّلة من نظام الملفات الجذري، مفهرسة بالملف وبالإعداد داخله.",
